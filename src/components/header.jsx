            ...
            <header className='h-auto w-screen bg-[#fffdfd] flex lg:px-28 flex-col justify-center z-10  mb-3 sticky top-0 '>
                ...
                <motion.div
                    ...
                    <div className='w-3/5'>
                        ...
                        <Link to="/">
                            <motion.div
                                className='flex justify-start items-center font-semibold'><img src={logo} alt="Logo"  className='w-12 h-12'/> <span className='text-2xl tracking-wide text-slate-700'><span className=' font-serif'>P</span><span className='text-black font-serif'>a</span ><span className='text-black font-serif'>n</span><span className=' font-serif'>c</span><span className=' font-serif'>o</span><span className=' font-serif'>n</span><span className=' font-serif'>g</span><span className=' font-serif'> </span><span className=' font-serif'>L</span><span className=' font-serif'>u</span><span className=' font-serif'>m</span><span className=' font-serif'>e</span><span className=' font-serif'>r</span></span></motion.div>
                        </Link>
                    </div>
                            ...
                            <NavLink to="/foods">
                                <motion.li whileTap={{
                                    ...
                                    transition: { duration: 0.5 },
                                           ...
                                           className={`relative  flex items-center gap-x-2  (navData) => (navData.isActive ? 'active' : '')`} >List Menu < MdRestaurantMenu /> </motion.li>
                            </NavLink>
                            <NavLink to="/aboutus">
                                <motion.li whileTap={{
                                    scale: 0.8,
