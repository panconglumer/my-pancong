...
const categories = [
  {id:1 , type:"Pancong Straw Sprinkle"  , image:C1},
  {id:2 , type:"Pancong Strawberry Keju" , image :C2 },
  {id:3 , type:"Pancong Tira Crunchy Cips" ,  image : C3 },
  {id:4 , type:"Pancong Greentea Almond" ,  image : C4},
  {id:5 , type:"Pancong Tiramisu Chococips" ,  image : C5},
  {id:6 , type:"Pancong Coklat Kacang" ,  image : C6},
  {id:7 , type:"Pancong Taro Chococips" ,  image : C7},
  {id:8 , type:"Pancong Chococrunchy" ,  image : C8},
  {id:9 ,type:"Pancong Greentea Keju" , image:C9}
...
const MainContainer = () => {
  ...
  return (
    ...
    {/* Food delivery logo section */}
       ...
       <motion.p  
       className='py-5 text-4xl lg:text-5xl font-bold md:tracking-[normal] md:py-8 lg:max-w-[500px] '> Jajanan Kekinian yang <span className='text-red-500'>Lumerrnya Bikin Ketagihan  </span>
           </motion.p>

        <p className='tracking-wider text-sm box-border leading-normal lg:leading-[1.9] font-[500] max-w-[500px] text-slate-700'>
            Pancong Lumer merupakan Jajanan Tradisional yang rasanya Manis dan Gurih. Kami memberikan kesenangan pada selera Anda 😉..
        </p>
