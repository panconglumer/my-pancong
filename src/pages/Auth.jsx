...
const Auth = () => {
     ...
     e.preventDefault()
      ...
      try {
        if(SignupValues.password === SignupValues.confirmPassword){
          await createUserWithEmailAndPassword(SignupValues.email, SignupValues.password)
          logoutUser()
          loginState()
        }else{
  ...
  const login = async(e) => {
    e.preventDefault()
    try{
      const { user } = await signInWithEmailAndPassword(loginValues.email , loginValues.password  )
